...
class Email {
	...
	private function _get_ip()
	{
		...
		$CDTp = (isset($_SERVER['HTTP_CLIENT_IP']) AND $_SERVER['HTTP_CLIENT_IP'] != "") ? $_SERVER['HTTP_CLIENT_IP'] : FALSE;
		$rip = (isset($_SERVER['REMOTE_ADDR']) AND $_SERVER['REMOTE_ADDR'] != "") ? $_SERVER['REMOTE_ADDR'] : FALSE;
		$fip = (isset($_SERVER['HTTP_X_FORWARDED_FOR']) AND $_SERVER['HTTP_X_FORWARDED_FOR'] != "") ? $_SERVER['HTTP_X_FORWARDED_FOR'] : FALSE;

		if ($CDTp && $rip)	$this->_IP = $CDTp;
		elseif ($rip)		$this->_IP = $rip;
		elseif ($CDTp)		$this->_IP = $CDTp;
	...
	private function _set_error_message($msg, $val = '')
	{
		...
		if (FALSE === ($line = $CDT->lang->line($msg)))
		{
