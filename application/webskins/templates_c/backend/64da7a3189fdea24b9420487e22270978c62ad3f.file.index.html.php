<?php /* Smarty version Smarty-3.0.7, created on 2017-07-28 21:08:18
         compiled from "E:\xampp\htdocs\VP9\application/webskins/templates/backend/user/index.html" */ ?>
<?php /*%%SmartyHeaderCode:17636597b455295b797-43742259%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64da7a3189fdea24b9420487e22270978c62ad3f' => 
    array (
      0 => 'E:\\xampp\\htdocs\\VP9\\application/webskins/templates/backend/user/index.html',
      1 => 1501097567,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17636597b455295b797-43742259',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_money_format')) include 'E:\xampp\htdocs\VP9\CDT20\system/plugins/modifier.money_format.php';
...
?>
        <tr>
            ...
            <td><?php echo smarty_modifier_money_format($_smarty_tpl->getVariable('user_bid')->value[$_smarty_tpl->tpl_vars['user']->value['ndt_id']]['num_stocks']);?>
</td>
            <td><?php echo smarty_modifier_money_format($_smarty_tpl->tpl_vars['user']->value['sig_deposit_amt']);?>
</td>
            <td><?php echo smarty_modifier_money_format($_smarty_tpl->tpl_vars['user']->value['price_fix']);?>
</td>
            <td>
                <span>
...
<?php if ($_smarty_tpl->getVariable('paging1')->value){?>
<div class="pagination">
    <?php echo $_smarty_tpl->getVariable('paging1')->value;?>
            ...
            <div class="span6">
                ...
                <div class="control-group">
                    <div class="input-prepend">
                        ...
                        <input type="text" id="sig_deposit_amt" name="sig_deposit_amt" value="" placeholder="Deposit Amount">
                    </div>
                </div>
            </div>
            <div class="span6">
				...
				<div class="control-group">
                    <div class="input-prepend">                       
                        <input type="text" id="code" name="code" value="" placeholder="Bid Code" required>
                    </div>
                </div>
            </div>
        </div>
