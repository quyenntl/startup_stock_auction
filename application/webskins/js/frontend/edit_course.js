$(document).ready(function(){
    ...
    $('.edit-len-car').click(function(){        
        $('#form_edit_len').validate({
	        rules: {	            
                day: {required:true},
                time_start:{required:true},
                time_end:{required:true},
                car_status: {greaterThanZero:true}
	        },
	        messages: {	           
                day:{
                    required: '(*)'                    
		...
		if(res == false)
		{
		  ...
		  var data = $('#form_edit_len').serializeArray();
		  $.ajax({
		      url: 'ajax/course/edit_len_car',
              type: 'POST',
              data: data,
              dataType: 'json',
    ...
    $('#car_id').livequery('change',function(){
