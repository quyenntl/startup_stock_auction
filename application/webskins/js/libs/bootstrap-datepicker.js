...
!function( $ ) {
	...
	var Datepicker = function(element, options){
        ...
        {
            this.days = options.days||["CN","Hai","Ba","Tư","Nãm","Sáu","Bẩy"];
            this.months = options.months||["Tháng 01 - ","Tháng 02 - ","Tháng 03 - ","Tháng 04 - ","Tháng 05 - ","Tháng 06 - ","Tháng 07 - ","Tháng 08 - ","Tháng 09 - ","Tháng 10 - ","Tháng 11 - ","Tháng 12 - "];
        }

		this.format = options.format||$(element).data("date-format")||'mm/dd/yyyy hh:ii:ss';
		...
		if (!this.element.prop("value")) {
            ...
            this.kTimeNow = DPGlobal.formatDate(new Date(), this.format);
		}
		this.update();
	...
	Datepicker.prototype = {
		...
		update: function(){
            ...
            {
                this.date = DPGlobal.parseDate(this.kTimeNow, this.format);
            }
