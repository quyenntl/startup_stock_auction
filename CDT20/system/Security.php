...
class Security {
	...
	protected $_csrf_token_name		= 'cdt_csrf_token';
	protected $_csrf_cookie_name	= 'cdt_csrf_token';
	...
	public function xss_clean($str, $is_image = FALSE)
	{
		 ...
		 * Becomes: &lt;blink&gt;
		 */
		$naughty = 'alert|applet|audio|basefont|base|behavior|bgsound|blink|body|expression|form|frameset|frame|head|html|ilayer|input|isindex|layer|link|meta|plaintext|style|script|textarea|title|video|xml|xss';
