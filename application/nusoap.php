...
* $soapclient = new nusoapclient( string path [ ,mixed wsdl] );
*
...
class nusoapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function nusoapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::nusoap_base();
