...
class news_mod extends Module{
    ...
    function draw($params = array()){
        ...
        $total_data            = $this->gk_model->count(FE_NEWS, $condition, $like);        
        ...
        $list_tmp  = $this->gk_model->select(FE_NEWS, '*', $condition, $like, 'ordering ASC', $config['per_page'], $offset);
