...
elRTE.prototype.options   = {
	...
	panels      : {
        ...
        copypaste_new  : ['copy', 'cut', 'paste', 'pastetext', 'pasteformattext', 'removeformat'],
		undoredo   : ['undo', 'redo'],
	...
	toolbars    : {
		tiny     : ['style'],
        easy     : ['style1','lists'],
		compact  : ['save', 'copypaste_new', 'undoredo', 'style', 'alignment','colors', 'lists', 'media'],
        compact_min  : ['save', 'copypaste_new', 'undoredo', 'style', 'colors', 'lists', 'media'],
	...
	this.command = function() {
		...
		if (fm) {
			src.children('.ui-state-default')
				.click( function() {
					rte.options.fmOpen( function(url) { self.src.main.src.val(url.url).change() } );
				})
				.hover(function() {
