 ...
 */
class CDT_DB_utility extends CDT_DB_forge {
	...
	function backup($params = array())
	{
		...
		if ($prefs['format'] == 'zip')
		{
			...
			$CDT =& get_instance();
			$CDT->load->library('zip');
			$CDT->zip->add_data($prefs['filename'], $this->_backup($prefs));
			return $CDT->zip->get_zip();
		}
